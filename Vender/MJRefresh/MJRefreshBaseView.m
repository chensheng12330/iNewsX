...
- (UILabel *)labelWithFontSize:(CGFloat)size
{
    ...
    label.textColor = self.textColor==NULL? MJRefreshLabelTextColor:self.textColor;
...
-(void) setTextColor:(UIColor*) ftextColor
{
    if (self.textColor != NULL) {
        _textColor = nil;
    }
    
    _textColor = ftextColor;
    
    _lastUpdateTimeLabel.textColor = ftextColor;
    _statusLabel.textColor = ftextColor;
